...
const DUMMY_IMG =
  "https://thumbs.dreamstime.com/b/indian-man-close-up-handsome-portrait-outdoors-41860115.jpg";
...
const TestimonialCard = ({ name, treatment, review, stars }) => (
  <div className="tc">
    {/* Photo fills the card */}
    <div className="tc-photo">
      <img src={DUMMY_IMG} alt={name} />
    </div>
    ...
    <div className="tc-overlay">
      ...
      <div className="tc-author">
        <img className="tc-author-img" src={DUMMY_IMG} alt={name} />
